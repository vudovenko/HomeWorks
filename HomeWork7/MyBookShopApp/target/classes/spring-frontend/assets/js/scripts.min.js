    ...
    $(function () {
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="' + book.slug + '">'
                    + '       <img src="' + book.image + '">\n' + '</a>' +
                    ...
                    (book.status === 'PAID' ? ' <a class="Card-status" title="Куплена">' +
                        '<img src="/assets/img/icons/check.svg" alt="Куплена"></a>\n' : '') +
                    (book.status === 'CART' ? ' <a class="Card-status" title="В корзине">' +
                        '<img src="/assets/img/icons/shopping-basket.svg" alt="В корзине"></a>\n' : '') +
                    (book.status === 'KEPT' ? ' <a class="Card-status" title="Отложена">' +
                        '<img src="/assets/img/icons/heart.svg" alt="Отложена"></a>\n' : '')
                    ...
                    + book.authors + '                </div>\n'
                    + '                <div class="Card-cost">' +
                    (book.price ? '<span class="Card-priceOld">₽'
                        + book.price + '</span>\n' : '')
                    + '                       <span class="Card-price">₽'
                    + book.discountPrice + '</span>\n' + '                </div>\n'
                    + '              </div>\n' + '            </div>';
            }
            return {
                init: function () {
